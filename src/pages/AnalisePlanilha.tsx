...
export function AnalisePlanilha({ activeTab: activeTabProp, onTabChange }: AnalisePlanilhaProps = {}) {
  ...
  useEffect(() => {
    ...
    if (def && list.some((d) => d.id === def)) {
      setWppRecipientId(def)
    }
  }, [])
  ...
  const resolvedWppRecipientRaw = useMemo(
  ...
  const sendWppReport = useCallback(async () => {
    const telefone = resolvedWppRecipientRaw.trim()
  ...
  }, [resolvedWppRecipientRaw, wppMessage, closeWppModal])
  ...
  }, [resolvedWppRecipientRaw, reportText])
        ...
        <div className="flex flex-col gap-3 pt-4 border-t border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-end gap-3">
            <WppRecipientPicker
              ...
              manualPlaceholder="5511999999999 ou 120363...@g.us"
              className="flex flex-col gap-1.5 min-w-[200px] flex-1 max-w-md"
            />
            <button
              type="button"
              onClick={sendWppReportInline}
              disabled={wppSending || !resolvedWppRecipientRaw.trim() || !reportText.trim()}
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 sm:self-end"
            >
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex justify-end gap-2 p-4 border-t border-gray-200">
              ...
              <button
                ...
                disabled={wppSending || !resolvedWppRecipientRaw.trim() || !wppMessage.trim()}
